...
func (x *LoginResponse) GetResponse() *AuthResponse {
	if x != nil {
		return x.Response
	}
	return nil
...
var file_rpc_login_user_proto_rawDesc = []byte{
	...
	0x0b, 0x32, 0x10, 0x2e, 0x70, 0x62, 0x2e, 0x41, 0x75, 0x74, 0x68, 0x52, 0x65, 0x73, 0x70, 0x6f,
	0x6e, 0x73, 0x65, 0x52, 0x08, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x0c, 0x5a,
...
var file_rpc_login_user_proto_depIdxs = []int32{
	2, // 0: pb.LoginResponse.response:type_name -> pb.AuthResponse
